 ...
 *
 * It is a pattern, not a row in `links`. The drops are created in the
 ...
 * there. A fixed pattern needs nothing written anywhere: the moment a drop
 * exists, its short link works.
 *
